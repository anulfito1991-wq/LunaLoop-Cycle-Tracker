...
Data Sharing
LunaLoop does not automatically send cycle logs, symptom logs, or notes to a remote server in this build.
...
Health Disclaimer
LunaLoop provides general wellness education only. It is not medical advice, diagnosis, treatment, or contraception guidance.
